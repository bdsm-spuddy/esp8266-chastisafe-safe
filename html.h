...
<hr>
To talk to the Chastisafe Server you need to enter your API access token
details.  See the README on how to find this
<br>
Access token: <input name=token size=40 value="##token##">
<p>
<input type=submit value="Set API Details" name=setapi>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/renew">Renew now</a>
<p>
If this value is incorrect you will not be able to talk to the server
and will need to correct it.
<p>
The default endpoint this software talks to is the Chastisafe API.
This may be changed here (if no lock is running) to another endpoint
that supports the same endpoints.
<p>
...
<hr>
<a href="pick_lock">Pick a lock to start a session</a>
<hr>
<a href="change_auth.html">Change Safe Chastisafe Details</a>
<br>
<hr>
...
<html>
<body>
<center><h1>Chastisafe controls</h1></center>
</body>
</html>
)EOF");
